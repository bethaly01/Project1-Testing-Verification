...
public class ControlFlowGraphBuilder {
  ...
  class Visitor extends ASTVisitor {
     ...
     * 
     * <p>
     * firstReturn(S) := the index of the first return statement,
     ...
     * 
     * <p>
     * next(node) := statement following
     * 
     * <p>
     * then(node) := if defined(first(S_Then)) /\ !isReturn(last(S_Then)) then
     ...
     * 
     * <p>
     * else(node) is defined similarly to then(node).
     * 
     * @requires node != null
    ...
    public boolean visit(IfStatement node) {
      ...
      if (elseStatement != null) {
        ...
        statementList = getStatementList(new ArrayList<>());
        insertStatementList(node, statementList, nextStatement);
      }
    ...
    private ControlFlowGraph buildControlFlowGraph() {
      return new ControlFlowGraph() {
        ...
        final Map<Statement, Set<Statement>> successors = Collections.unmodifiableMap(Visitor.this.successors);
        final Map<Statement, Set<Statement>> predecessors = Collections.unmodifiableMap(Visitor.this.predecessors);
