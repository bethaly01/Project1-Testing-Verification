 ...
 *
 */
public class ConstantFolding implements Folding {
   ...
   */
  public boolean fold(ASTNode compilationUnit) {
    ...
    while (isChanged) {
      ...
      for (Folding folding : foldingList) {
        isChanged = folding.fold(compilationUnit) || isChanged;
      }
      if (!madeChange) {
        madeChange = isChanged;
      }
    }
  ...
  public static void main(String[] args) {
    ...
    (new ConstantFolding()).fold(compilationUnit);
